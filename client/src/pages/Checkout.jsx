...
const Checkout = () => {
  ...
  // console.log("_id =", cartItems[0]?._id);
  // console.log("id =", cartItems[0]?.id);
  // console.log("product =", cartItems[0]?.product);
  ...
  const handlePayment = async () => {
    try {
      ...
      const options = {
        key: 'rzp_test_T02EHMWyWsHUCr', // Student dummy fallback
  ...
  const bypassPayment = async () => {
    ...
    if (saveOrderRes.ok) {
      ...
      alert('Order saving failed: ' + (err.message || saveOrderRes.status));
    }
  };
